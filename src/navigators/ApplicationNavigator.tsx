...
import { TabBarNavigationItem, TabBarNavigationParticules, TabBarNavigationWeave } from "../components";
    ...
    useCode(
            () =>
                    block([
                        ...
                        set(activeTransition, timing({ duration: DURATION, easing: EasingNode.linear })),
                    ]),
    ...
    return (
            ...
            >
                ...
                <Tab.Screen name="ScreenIndividual" component={ScreenIndividual} options={{
                    tabBarLabel: "Cá nhân",
                    tabBarIcon: ({ color, size, focused }) => (
                            focused ? <Icon name="ios-compass" size={24}/> :
                                    <Icon name="ios-compass-outline" size={18}/>
                    )
                }}/>
            </Tab.Navigator>
    );
