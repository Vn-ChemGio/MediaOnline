...
import { Devices, ScreenVOVNewsChannelNavigationParamList } from "~commons";
import { AvatarHeaderScrollView, VOVNewsCardItem }          from "~components";
import { NewsItem }                                         from "~commons/interfaces/VOVNews";
import axios                                                from "axios";
import { API_HOST }                                         from "@env";
import { View }                                             from "react-native";

const ScreenVOVNewsChannelItem = ( props: DrawerScreenProps<ScreenVOVNewsChannelNavigationParamList> ) => {
...
export default ScreenVOVNewsChannelItem;
